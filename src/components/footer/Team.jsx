...
const Team = () => {
  ...
  return (
    <>
        <div className="bg-[#fff] lg:hidden py-[10vh] w-[90vw] lg:w-[70vw] lg:space-x-8 mx-auto" id="team" ref={ref}>
        ...
        {/* Desktop */}
        <div className="bg-[#fff] py-[10vh] lg:block hidden w-[70vw] mx-auto" id="team" ref={ref}>
